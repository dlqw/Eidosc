...
""";
    ...
    public void StdHashImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__combine3", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__combine_all", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__combine_seq", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__seq_with_seed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__seq", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__pair_with_seed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Hash__pair", StringComparison.Ordinal));
    }
    ...
    public void StdTaskRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__completed_raw_opt", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__completed_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__status_is_completed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__status_is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__status_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__spawn", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__await_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_raw_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_raw_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__is_empty", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__has_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__is_accepting", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn_raw_if_accepting", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn_if_accepting", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn_raw_or_completed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn_or_completed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__is_cancelled_or_empty", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn_raw", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__spawn", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__join_raw", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__join", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__collect_values", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__join_values", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_pending_count", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_is_cancelled", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_is_idle", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_has_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__TaskGroup__status_value_or_else", StringComparison.Ordinal));
    ...
    public void StdPromiseRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__try_await_raw_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__try_await_raw_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__fulfill_raw_if_non_null", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__is_fulfilled", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__status_is_fulfilled", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__status_is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__status_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__fulfill_raw_if_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__new_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__fulfill_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__try_await_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__try_await_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__try_await_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Promise__fulfill_value_if_pending", StringComparison.Ordinal));
        Assert.False(string.IsNullOrWhiteSpace(result.LlvmIrText));
    ...
    public void StdChannelRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__new_unbuffered", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_send_raw_if_non_null", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv_raw_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv_raw_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv_raw_status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_has_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_is_closed", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_fold", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__receive_status_fold_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__new_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_send", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Channel__try_recv_or_else", StringComparison.Ordinal));
        Assert.False(string.IsNullOrWhiteSpace(result.LlvmIrText));
            ...
            string.Join(
                ...
                remainingUnboxCalls.Select(item =>
                {
                    ...
                    var unboxFunctions = string.Join(
                        "; ",
                        mirModule.Functions
                            .Where(function => function.Name.Contains("std__Ffi__unbox_value", StringComparison.Ordinal))
    ...
    public void StdBarrierRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__new_single", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrive_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrive_tripped", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrive_status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrival_is_pending", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrival_is_tripped", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrival_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrival_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrive_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__arrive_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__wait_raw", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Barrier__wait", StringComparison.Ordinal));
    }
    ...
    public void StdSyncRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__try_lock_then_unlock", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__try_with_lock", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__new_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__try_with_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__try_update", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__status_is_available", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__status_is_locked", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Mutex__status_value_or_else", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_read_then_unlock", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_write_then_unlock", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_with_read", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_with_write", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__new_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_with_read_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_with_write_value", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__try_update", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status_is_idle", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status_is_readable", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status_is_blocked", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status_value_or", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__RwLock__status_value_or_else", StringComparison.Ordinal));
    ...
    public void StdAsyncRuntimeImportFixture_CompilesThroughLlvm()
    {
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__run", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__start", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__start_default", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__shutdown", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__worker_index", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__AsyncRuntime__with_scheduler", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
        ...
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Async__spawn", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Async__await", StringComparison.Ordinal));
        Assert.Contains(
            llvmModule.Functions,
            function => function.Name.Contains("std__Task__try_await_value_or_else", StringComparison.Ordinal));
        Assert.Contains("eidos_task_spawn_closure_value", result.LlvmIrText, StringComparison.Ordinal);
