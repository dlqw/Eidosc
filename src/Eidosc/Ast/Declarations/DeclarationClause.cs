...
public static class ClauseSchema
{
    ...
    private static readonly IReadOnlyDictionary<string, DeclarationClauseSpec> Specs =
        new Dictionary<string, DeclarationClauseSpec>(StringComparer.Ordinal)
        {
            ...
            ["extern"] = new("extern", DeclarationClauseKind.Extern, DeclarationClauseTarget.Function | DeclarationClauseTarget.Value, ClauseArgumentGrammar.TokenIsland, ClauseCanonicalArgumentType.Abi, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-ffi-to-extern-c", ["ffi"]), Adapter: DeclarationAttachmentAdapterKind.ForeignContract),
            ...
            ["compiler"] = new("compiler", DeclarationClauseKind.Compiler, DeclarationClauseTarget.AnyDeclaration, ClauseArgumentGrammar.TokenIsland, ClauseCanonicalArgumentType.CompilerDirective, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Repeatable: true, Privilege: ClausePrivilegePolicy.ToolchainOwnedSource, Migration: new("compiler-directive", ["internal", "intrinsic", "llvm_abi", "role"]), Adapter: DeclarationAttachmentAdapterKind.CompilerDirective)
        };
