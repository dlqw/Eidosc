...
public static class ClauseSchema
{
    ...
    private static readonly IReadOnlyDictionary<string, DeclarationClauseSpec> Specs =
        new Dictionary<string, DeclarationClauseSpec>(StringComparer.Ordinal)
        {
            ...
            ["extern"] = new("extern", DeclarationClauseKind.Extern, DeclarationClauseTarget.Function, ClauseArgumentGrammar.Identifier, ClauseCanonicalArgumentType.Abi, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Need], Conflicts: [DeclarationClauseKind.Intrinsic], Migration: new("attribute-ffi-to-extern-c", ["ffi"]), Adapter: DeclarationAttachmentAdapterKind.ForeignContract),
            ["link_library"] = new("link_library", DeclarationClauseKind.LinkLibrary, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Extern], Migration: new("attribute-ffi-library", ["ffi"]), Adapter: DeclarationAttachmentAdapterKind.ForeignContract),
            ["link_name"] = new("link_name", DeclarationClauseKind.LinkName, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Extern], Migration: new("attribute-ffi-symbol", ["ffi"]), Adapter: DeclarationAttachmentAdapterKind.ForeignContract),
            ...
            ["operator"] = new("operator", DeclarationClauseKind.Operator, DeclarationClauseTarget.Function, ClauseArgumentGrammar.TokenIsland, ClauseCanonicalArgumentType.Operator, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Repeatable: true, Migration: new("attribute-operator", ["operator"]), Adapter: DeclarationAttachmentAdapterKind.DedicatedDeclaration),
