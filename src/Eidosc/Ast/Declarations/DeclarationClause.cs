...
public static class ClauseSchema
{
    ...
    private static readonly IReadOnlyDictionary<string, DeclarationClauseSpec> Specs =
        new Dictionary<string, DeclarationClauseSpec>(StringComparer.Ordinal)
        {
            ...
            ["repr"] = new("repr", DeclarationClauseKind.Repr, DeclarationClauseTarget.Type, ClauseArgumentGrammar.Identifier, ClauseCanonicalArgumentType.Identifier, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-cstruct-to-repr-c", ["cstruct"])),
            ["extern"] = new("extern", DeclarationClauseKind.Extern, DeclarationClauseTarget.Function, ClauseArgumentGrammar.Identifier, ClauseCanonicalArgumentType.Abi, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Need], Conflicts: [DeclarationClauseKind.Intrinsic], Migration: new("attribute-ffi-to-extern-c", ["ffi"])),
            ["link_library"] = new("link_library", DeclarationClauseKind.LinkLibrary, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Extern], Migration: new("attribute-ffi-library", ["ffi"])),
            ["link_name"] = new("link_name", DeclarationClauseKind.LinkName, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Requires: [DeclarationClauseKind.Extern], Migration: new("attribute-ffi-symbol", ["ffi"])),
            ["derive"] = new("derive", DeclarationClauseKind.Derive, DeclarationClauseTarget.Type | DeclarationClauseTarget.CaseType, ClauseArgumentGrammar.PathList, ClauseCanonicalArgumentType.Trait, ClauseStage.Semantic, ClauseSourceOrderBehavior.GeneratorSequence, Repeatable: true, ProducesMetaInvocation: true, CompilerOwnedInvocation: true, Migration: new("attribute-derive", ["derive"])),
            ["impl"] = new("impl", DeclarationClauseKind.Impl, DeclarationClauseTarget.Function, ClauseArgumentGrammar.Path, ClauseCanonicalArgumentType.Trait, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-impl", ["impl"])),
            ["operator"] = new("operator", DeclarationClauseKind.Operator, DeclarationClauseTarget.Function, ClauseArgumentGrammar.TokenIsland, ClauseCanonicalArgumentType.Operator, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Repeatable: true, Migration: new("attribute-operator", ["operator"])),
            ["borrow"] = new("borrow", DeclarationClauseKind.Borrow, DeclarationClauseTarget.Function, ClauseArgumentGrammar.IdentifierList, ClauseCanonicalArgumentType.BorrowCapability, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-borrow", ["borrow"])),
            ["proof_unfold"] = new("proof_unfold", DeclarationClauseKind.ProofUnfold, DeclarationClauseTarget.Function, ClauseArgumentGrammar.Path, ClauseCanonicalArgumentType.Declaration, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-proof-unfold", ["proof_unfold"])),
            ["transparent"] = new("transparent", DeclarationClauseKind.Transparent, DeclarationClauseTarget.Function, ClauseArgumentGrammar.None, ClauseCanonicalArgumentType.None, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Migration: new("attribute-transparent", ["transparent"])),
            ["before"] = new("before", DeclarationClauseKind.Before, DeclarationClauseTarget.Function, ClauseArgumentGrammar.PathList, ClauseCanonicalArgumentType.Generator, ClauseStage.Syntax, ClauseSourceOrderBehavior.OrderingConstraint, Repeatable: true, MetaGeneratorOnly: true, Migration: NoLegacyMigration),
            ["after"] = new("after", DeclarationClauseKind.After, DeclarationClauseTarget.Function, ClauseArgumentGrammar.PathList, ClauseCanonicalArgumentType.Generator, ClauseStage.Syntax, ClauseSourceOrderBehavior.OrderingConstraint, Repeatable: true, MetaGeneratorOnly: true, Migration: NoLegacyMigration),
            ["expand"] = new("expand", DeclarationClauseKind.Expand, DeclarationClauseTarget.AnyDeclaration, ClauseArgumentGrammar.MetaInvocation, ClauseCanonicalArgumentType.MetaInvocation, ClauseStage.Semantic, ClauseSourceOrderBehavior.GeneratorSequence, Repeatable: true, ProducesMetaInvocation: true, Migration: new("attribute-generator-to-expand", ["generator"])),
            ["requires"] = new("requires", DeclarationClauseKind.Requires, DeclarationClauseTarget.Function, ClauseArgumentGrammar.PathList, ClauseCanonicalArgumentType.Generator, ClauseStage.Syntax, ClauseSourceOrderBehavior.OrderingConstraint, Repeatable: true, MetaGeneratorOnly: true, Migration: NoLegacyMigration),
            ["internal"] = new("internal", DeclarationClauseKind.Internal, DeclarationClauseTarget.AnyDeclaration, ClauseArgumentGrammar.None, ClauseCanonicalArgumentType.None, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Privilege: ClausePrivilegePolicy.ToolchainOwnedSource, Migration: new("attribute-internal", ["internal"])),
            ["intrinsic"] = new("intrinsic", DeclarationClauseKind.Intrinsic, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Semantic, ClauseSourceOrderBehavior.Preserve, Privilege: ClausePrivilegePolicy.ToolchainOwnedSource, Conflicts: [DeclarationClauseKind.Extern], Migration: new("attribute-intrinsic", ["intrinsic"])),
            ["llvm_abi"] = new("llvm_abi", DeclarationClauseKind.LlvmAbi, DeclarationClauseTarget.Function, ClauseArgumentGrammar.String, ClauseCanonicalArgumentType.String, ClauseStage.Layout, ClauseSourceOrderBehavior.Preserve, Privilege: ClausePrivilegePolicy.ToolchainOwnedSource, Migration: new("attribute-llvm-abi", ["llvm_abi"]))
        };
