...
public sealed partial class SymbolTable
{
    private string GetTypeName(TypeId typeId)
    {
        return typeId.Value switch
        {
            ...
            WellKnownTypeIds.UInt64Id => WellKnownStrings.BuiltinTypes.UInt64,
            WellKnownTypeIds.UInt32Id => WellKnownStrings.BuiltinTypes.UInt32,
            WellKnownTypeIds.UInt16Id => WellKnownStrings.BuiltinTypes.UInt16,
            WellKnownTypeIds.UInt8Id => WellKnownStrings.BuiltinTypes.UInt8,
