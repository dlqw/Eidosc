...
public sealed partial class SymbolTable
{
    ...
    private void RegisterBuiltinTypes()
    {
        ...
        var builtinTypes = new (string Name, TypeId TypeId)[]
        {
            ...
            (WellKnownStrings.BuiltinTypes.UInt64, new TypeId(WellKnownTypeIds.UInt64Id)),
            (WellKnownStrings.BuiltinTypes.UInt32, new TypeId(WellKnownTypeIds.UInt32Id)),
            (WellKnownStrings.BuiltinTypes.UInt16, new TypeId(WellKnownTypeIds.UInt16Id)),
            (WellKnownStrings.BuiltinTypes.UInt8, new TypeId(WellKnownTypeIds.UInt8Id)),
