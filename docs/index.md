# Eidos toolchain documentation

This offline documentation set matches the Eidosc version that installed it.

- [Eidosup toolchain management](eidosup/toolchain-management.md)
- [Components, profiles, targets, and offline docs](eidosup/components-profiles-targets.md)
...
- [Functional ADT derives](architecture/functional-derives.md)
