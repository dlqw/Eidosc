<p align="center">
  <img src="docs/assets/eidos.svg" width="96" height="96" alt="Eidos 标志">
</p>
...
<p align="center">
  ...
  <img alt="状态：预发布" src="https://img.shields.io/badge/status-prerelease-f0a45d">
...
> 包括不兼容变化。当前语言基线为 **Eidos 0.5.0-alpha.1**；Eidos 语言、
